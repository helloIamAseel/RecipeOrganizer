...
export default function Favorites() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-4xl font-serif font-bold text-[#a54d2a] mb-8">My Favorites</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-[#a54d2a] text-xl font-serif">No favorites yet — like some recipes!</p>
        </div>
      ) : (
